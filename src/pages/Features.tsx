      ...
      items: [
        {
          ...
          description: "Real-time wallet balance, quick actions, and recent transactions in one glance"
        },
        {
          icon: <Upload className="w-6 h-6" />,
          title: "Easy Deposits",
          description: "Add money through agent cash-in simulation with instant confirmation"
        },
        {
        ...
        },
        {
          ...
          title: "Send Money",
          description: "Transfer funds to any user by searching phone number or email"
        },
        {
          icon: <History className="w-6 h-6" />,
          title: "Transaction History",
          description: "Complete history with pagination and smart filtering by type/date range"
        },
        {
    ...
    agent: {
      ...
      items: [
        ...
        },
        {
          ...
          title: "Add Money",
          description: "Securely add funds to any user's wallet with verification"
        },
        {
          icon: <Wallet className="w-6 h-6" />,
          title: "Process Withdrawals",
          description: "Handle user withdrawal requests efficiently and securely"
        },
        {
          icon: <Eye className="w-6 h-6" />,
          title: "Transaction Monitoring",
          description: "View and track all transactions handled by your agent account"
        },
        {
      ...
      items: [
        {
          ...
          description: "Total users, agents, transaction count, and volume analytics"
        },
        {
          icon: <Users className="w-6 h-6" />,
          title: "User Management",
          description: "View, block, and unblock users with comprehensive controls"
        },
        {
        ...
        },
        {
          ...
          description: "Powerful search bars and filters across all listing pages"
        },
        {
          icon: <Filter className="w-6 h-6" />,
          title: "Smart Filtering",
          description: "Filter by category, status, amount, and more with pagination"
        },
        {
          icon: <Settings className="w-6 h-6" />,
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-6 sm:mb-8 max-w-3xl mx-auto px-2">
              Revolutionary digital wallet solution with comprehensive dashboards for users, agents, and administrators
            </p>
        ...
        <div className="bg-card rounded-2xl sm:rounded-3xl border shadow-lg overflow-hidden">
          <div className={`${features[activeTab].color} p-6 sm:p-8 text-white`}>
            <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold">{features[activeTab].title}</h2>
            </div>
            <p className="text-lg sm:text-xl text-white/90">{features[activeTab].description}</p>
          </div>
        ...
        <div className="bg-card rounded-3xl border shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-2xl font-bold text-foreground mb-2">Real-time</h4>
              <p className="text-muted-foreground">Instant transaction processing</p>
            </div>
            <div className="text-center">
              <div className="inline-flex p-4 bg-rose-600 rounded-2xl mb-4">
                <Lock className="w-8 h-8 text-white" />
              </div>
              <h4 className="text-2xl font-bold text-foreground mb-2">Secure</h4>
              <p className="text-muted-foreground">Bank-level security protocols</p>
            </div>
            <div className="text-center">
              <div className="inline-flex p-4 bg-rose-700 rounded-2xl mb-4">
                <Filter className="w-8 h-8 text-white" />
              </div>
              <h4 className="text-2xl font-bold text-foreground mb-2">Advanced</h4>
              <p className="text-muted-foreground">Smart filtering & pagination</p>
            </div>
            <div className="text-center">
              <div className="inline-flex p-4 bg-rose-800 rounded-2xl mb-4">
                <BarChart3 className="w-8 h-8 text-white" />
              </div>
              <h4 className="text-2xl font-bold text-foreground mb-2">Analytics</h4>
              <p className="text-muted-foreground">Comprehensive reporting tools</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24 text-center">
        <div className="bg-rose-500 rounded-2xl sm:rounded-3xl p-8 sm:p-12 text-white">
          ...
          <p className="text-lg sm:text-xl text-rose-50 mb-6 sm:mb-8 px-2">
            Experience the future of digital wallet management with DigiWallet's comprehensive dashboard system.
          </p>
          <Link to="/register" className="w-full sm:w-auto bg-white text-rose-600 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-gray-50 transition-colors duration-300 hover:scale-105 transform shadow-lg">
            Get Started Today
          </Link>
        </div>
      </div>
