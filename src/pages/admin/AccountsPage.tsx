...
export default function AccountsPage() {
  ...
  const handleSearchBox = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === "Enter") {
      setActualTerm(searchTerm);
    }
  };
  return (
    <div>
      ...
      <div className="md:grid grid-cols-4 md:gap-3">
        <div className="w-full col-span-1 max-w-3xl my-3 md:my-0">
          <Card className="rounded-md py-6 gap-2">
            ...
            <CardContent>
              ...
              />
              <div>
                <h1 className="mt-4 font-medium">Filter By</h1>
              </div>
              <Accordion
                type="multiple"
                className="w-full"
                    ...
                    {roleOptions.map((opt) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={() => setSelectedRole(opt.value)}
                        />
